...
base_path <- file.path("processed", "la_dtrng")
output_path <- file.path("processed", "diurnal_range_bins")
...
test_files <- list.files(file.path("processed", "la_dtrng", "LA_DTRNG_2003"),
                         full.names = TRUE)
